...
static void	init_shortest(t_sort *s, int *tmp, short *act)
{
...
static void	set_rr(t_sort *s, int *tmp)
{
...
static void	set_rrr(t_sort *s, int *tmp)
{
...
static void	init_shortest_prepare(t_sort *s, short *act)
{
	int	tmp[8];
