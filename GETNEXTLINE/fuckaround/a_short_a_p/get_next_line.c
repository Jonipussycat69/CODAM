...
/*   Updated: 2023/11/24 20:43:11 by jdobos           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	v.out = 0; v.btsr = BUF_SIZE; v.read_if = 0;
	WHILE(v.btsr == BUF_SIZE && v.out == 0, {v.i_1 = 0;
	READ_IF(v.read_if == 1, fd, buffer, BUF_SIZE, v.btsr)
	v.read_if = 1;
