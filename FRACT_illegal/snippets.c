...
t_uint	color_log_interpolate(t_color c_l, t_color c_h, double t)
{
	...
	d.r = (1.0 - t) * log(mx(c_l.r, e)) + t * log(mx(c_h.r, e));
	d.g = (1.0 - t) * log(mx(c_l.g, e)) + t * log(mx(c_h.g, e));
	d.b = (1.0 - t) * log(mx(c_l.b, e)) + t * log(mx(c_h.b, e));
	d.a = (1.0 - t) * log(mx(c_l.a, e)) + t * log(mx(c_h.a, e));
	c.r = (t_uchar)(round_to_uint(d.r));
	c.g = (t_uchar)(round_to_uint(d.g));
	c.b = (t_uchar)(round_to_uint(d.b));
	c.a = (t_uchar)(round_to_uint(d.a));
	return (rgba_to_hex(c));
}
